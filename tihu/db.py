...
challenges = Table('challenges', metadata, col_id(), owner(), C('title', String(100), nullable=False), C('description', Text, nullable=False), C('category', String(30), nullable=False), C('current_version', Integer, nullable=False), C('archived', Boolean, nullable=False, default=False), C('art', Text, nullable=True), C('created', Float, nullable=False))
