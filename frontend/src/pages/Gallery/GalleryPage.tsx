...
export function GalleryPage() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full pb-16 animate-in fade-in duration-200">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-slate-500 text-xs">
            各路模型在无人工干预的隔离沙箱中真实生成的互动网页与动画作品。
          </p>
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3 rounded-2xl bg-white border border-slate-200 shadow-xs">
        ...
        <div className="relative w-full sm:w-60">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-slate-800"
          />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center p-16 rounded-3xl bg-white border border-slate-200 text-center gap-3 shadow-xs">
          ...
          <h3 className="text-base font-semibold text-slate-800">暂无公开的作品</h3>
          <p className="text-xs text-slate-500">快去实验室完成第一个实验并公开发布吧！</p>
              ...
              >
                ...
                <div className="relative h-44 w-full bg-slate-50 flex items-center justify-center overflow-hidden border-b border-slate-100">
                  {run.thumbnail_available ? (
                    ...
                    <div className="flex flex-col items-center gap-2 text-slate-400">
                      <VendorIcon name={run.model} size={32} />
                ...
                <div className="p-4 flex-1 flex flex-col justify-between gap-3.5">
                  <div className="flex flex-col gap-1">
                    ...
                    <h3 className="text-sm font-semibold text-slate-900 group-hover:text-sky-700 transition-colors line-clamp-1">
                      {run.username} 的实验成果
                    </h3>
                  </div>
